...
Доступ к nginx будет осуществляться за счет dns сервера, который будет выдавать нужный IP по которому будем переходить.
...
![image](https://github.com/Antihoman/Highload-Yandex-Food/assets/91897029/b27fd584-0bd8-43a9-b9d6-3fb82e77831b)
